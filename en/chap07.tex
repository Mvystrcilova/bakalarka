...
\end{figure}
Next there is a possibility to add a song, which redirects the user to a form he fills out asking for a name of the song, the artist, the lyrics and a YouTube link. When he clicks add, this song is added to the database and has the same possibilities as the others.\\
...
\end{figure}
There is also a search bar, where one can search for songs based on title and artist. \\
...
Right to the song, there are its ten most similar songs. Here even disliked and played songs are included. \\
