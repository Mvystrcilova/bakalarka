...
\def\Keywords{%
{music recommendation,} {unsupervised feature learning,} {audio-based song similarity,} {lyrics-based song similarity}
}
...
\begin{itemize}
    \item A folder called \texttt{songRecommender\_project} containing the source code of the project. It includes a \texttt{README.md} file that describes the project's directories and modules.
    \item User documentation in pdf format under the name \texttt{srUserDocs.pdf} also included in the \texttt{songRecommender\_project} directory
\end{itemize}
